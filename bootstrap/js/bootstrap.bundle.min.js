...
!(function (t, e) {
  ...
  const t = {
      ...
      prev(t, e) {
        let i = t.AnteriorElementSibling;
        for (; i; ) {
          if (i.matches(e)) return [i];
          i = i.AnteriorElementSibling;
        }
        return [];
      },
      proximo(t, e) {
        let i = t.proximoElementSibling;
        for (; i; ) {
          if (i.matches(e)) return [i];
          i = i.proximoElementSibling;
        }
        return [];
      },
    },
  ...
  class Z extends B {
    ...
    proximoWhenVisible() {
      !document.hidden && c(this._element) && this.proximo();
    }
    prev() {
      this._slide(X);
    }
  ...
  class et extends B {
    ...
    Mostrar() {
      ...
      if (P.trigger(this._element, "Mostrar.bs.collapse").defaultPrevented)
        return;
      e &&
        e.forEach((t) => {
      ...
      this._queueCallback(
        () => {
          this._element.classList.remove("collapsing"),
            ...
            P.trigger(this._element, "Mostrarn.bs.collapse");
        },
        this._element,
        !0
      ),
    ...
    _addAriaAndCollapsedClass(t, e) {
      ...
      const i = t.classList.contains("Mostrar");
      e.forEach((t) => {
  ...
  class Ae extends B {
    ...
    Mostrar() {
      if (h(this._element) || this._menu.classList.contains("Mostrar")) return;
      const t = Ae.getParentFromElement(this._element),
        e = { relatedTarget: this._element };
      if (
        !P.trigger(this._element, "Mostrar.bs.dropdown", e).defaultPrevented
      ) {
        ...
        "ontouchstart" in document.documentElement &&
          ...
          P.trigger(this._element, "Mostrarn.bs.dropdown", e);
      }
    }
    hide() {
      if (h(this._element) || !this._menu.classList.contains("Mostrar")) return;
    ...
    _getMenuElement() {
      return t.proximo(this._element, ".dropdown-menu")[0];
    }
    _getPlacement() {
    ...
    static clearMenus(e) {
      ...
      for (let t = 0, n = i.length; t < n; t++) {
        ...
        if (!n._element.classList.contains("Mostrar")) continue;
    ...
    static dataApiKeydownHandler(e) {
      if (
        ...
        return;
      const i = this.classList.contains("Mostrar");
  ...
  class De extends B {
    ...
    Mostrar(t) {
      this._isMostrarn ||
        ...
        P.trigger(this._element, "Mostrar.bs.modal", { relatedTarget: t })
          .defaultPrevented ||
        ((this._isMostrarn = !0),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._element.focus(),
              (this._isTransitioning = !1),
              P.trigger(this._element, "Mostrarn.bs.modal", {
                relatedTarget: e,
              });
          },
          this._dialog,
  ...
  class Ne extends B {
    ...
    Mostrar(t) {
      this._isMostrarn ||
        P.trigger(this._element, "Mostrar.bs.offcanvas", { relatedTarget: t })
          .defaultPrevented ||
        ((this._isMostrarn = !0),
        ...
        this._queueCallback(
          () => {
            P.trigger(this._element, "Mostrarn.bs.offcanvas", {
              relatedTarget: t,
            });
          },
          this._element,
  ...
  P.on(
    ...
    function (e) {
      ...
      const n = t.findOne(".offcanvas.Mostrar");
    ...
    P.on(window, "load.bs.offcanvas.data-api", () =>
      t
        ...
        .forEach((t) => Ne.getOrCreateInstance(t).Mostrar())
    ),
    _(Ne);
  const je = new Set([
      "background",
  ...
  class Fe extends B {
    ...
    Mostrar() {
      ...
      const t = P.trigger(this._element, this.constructor.Event.Mostrar),
        i = d(this._element),
        n =
          null === i
      ...
      this._queueCallback(
        () => {
          ...
          (this._hoverState = null),
            P.trigger(this._element, this.constructor.Event.MostrarN),
  ...
  class ti extends B {
    ...
    Mostrar() {
      ...
      const o = e
        ...
        : null;
      if (
        P.trigger(this._element, "Mostrar.bs.tab", { relatedTarget: e })
          .defaultPrevented ||
      ...
      const r = () => {
        P.trigger(e, "hidden.bs.tab", { relatedTarget: this._element }),
          P.trigger(this._element, "Mostrarn.bs.tab", { relatedTarget: e });
      };
    ...
    _activate(e, i, n) {
      ...
      s && o
        ? (s.classList.remove("Mostrar"), this._queueCallback(r, e, !0))
        : r();
    }
  ...
  P.on(
    ...
    function (t) {
      ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        h(this) || ti.getOrCreateInstance(this).Mostrar();
    }
  ),
    _(ti);
  ...
  class ni extends B {
    ...
    Mostrar() {
      P.trigger(this._element, "Mostrar.bs.toast").defaultPrevented ||
        (this._clearTimeout(),
        ...
        this._queueCallback(
          () => {
            this._element.classList.remove("Mostraring"),
              this._element.classList.add("Mostrar"),
              P.trigger(this._element, "Mostrarn.bs.toast"),
