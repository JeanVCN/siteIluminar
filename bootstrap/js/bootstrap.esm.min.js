...
const NODE_TEXT = 3,
  SelectorEngine = {
    ...
    prev(e, t) {
      let n = e.AnteriorElementSibling;
      for (; n; ) {
        if (n.matches(t)) return [n];
        n = n.AnteriorElementSibling;
      }
      return [];
    },
    proximo(e, t) {
      let n = e.proximoElementSibling;
      for (; n; ) {
        if (n.matches(t)) return [n];
        n = n.proximoElementSibling;
      }
      return [];
    },
  },
  ...
  getproximoActiveElement = (e, t, n, i) => {
    let s = e.indexOf(t);
...
const Manipulator = {
  ...
  CLASS_NAME_proximo = "carousel-item-proximo",
  ...
  SELECTOR_proximo_PREV = ".carousel-item-proximo, .carousel-item-prev",
...
class Carousel extends BaseComponent {
  ...
  proximoWhenVisible() {
    !document.hidden && isVisible(this._element) && this.proximo();
  }
  prev() {
  ...
  pause(e) {
    e || (this._isPaused = !0),
      SelectorEngine.findOne(SELECTOR_proximo_PREV, this._element) &&
  ...
  to(e) {
    ...
    const n = e > t ? ORDER_proximo : ORDER_PREV;
  ...
  _getItemByOrder(e, t) {
    const n = e === ORDER_proximo;
    return getproximoActiveElement(this._items, t, n, this._config.wrap);
  }
  ...
  _slide(e, t) {
    const n = this._directionToOrder(e),
      ...
      E = l ? CLASS_NAME_proximo : CLASS_NAME_PREV,
  ...
  _orderToDirection(e) {
    return [ORDER_proximo, ORDER_PREV].includes(e)
      ? isRTL()
        ? e === ORDER_PREV
          ? DIRECTION_LEFT
          : DIRECTION_RIGHT
...
class Collapse extends BaseComponent {
  ...
  toggle() {
    this._element.classList.contains("Mostrar") ? this.hide() : this.Mostrar();
  }
  Mostrar() {
    if (this._isTransitioning || this._element.classList.contains("Mostrar"))
      return;
    let e, t;
    this._parent &&
    ...
    if (EventHandler.trigger(this._element, EVENT_Mostrar$5).defaultPrevented)
      return;
    e &&
      e.forEach((e) => {
    ...
    this._queueCallback(
      () => {
        this._element.classList.remove("collapsing"),
          this._element.classList.add("collapse", "Mostrar"),
  ...
  hide() {
    ...
    (this._element.style[e] = this._element.getBoundingClientRect()[e] + "px"),
      ...
      this._element.classList.add("collapsing"),
      this._element.classList.remove("collapse", "Mostrar");
  ...
  _addAriaAndCollapsedClass(e, t) {
    ...
    const n = e.classList.contains("Mostrar");
    t.forEach((e) => {
...
const NAME$8 = "dropdown",
  ...
  EVENT_Mostrar$4 = "Mostrar.bs.dropdown",
  EVENT_MostrarN$4 = "Mostrarn.bs.dropdown",
...
class Dropdown extends BaseComponent {
  ...
  toggle() {
    isDisabled(this._element) ||
      (this._element.classList.contains("Mostrar")
        ? this.hide()
        : this.Mostrar());
  }
  Mostrar() {
    if (isDisabled(this._element) || this._menu.classList.contains("Mostrar"))
      return;
    const e = Dropdown.getParentFromElement(this._element),
      t = { relatedTarget: this._element };
    if (
      !EventHandler.trigger(this._element, EVENT_Mostrar$4, t).defaultPrevented
    ) {
      if (this._inNavbar)
      ...
      "ontouchstart" in document.documentElement &&
        ...
        this._menu.classList.toggle("Mostrar"),
        this._element.classList.toggle("Mostrar"),
        EventHandler.trigger(this._element, EVENT_MostrarN$4, t);
    }
  }
  hide() {
    if (isDisabled(this._element) || !this._menu.classList.contains("Mostrar"))
  ...
  _completeHide(e) {
    EventHandler.trigger(this._element, EVENT_HIDE$4, e).defaultPrevented ||
      ...
      this._menu.classList.remove("Mostrar"),
      this._element.classList.remove("Mostrar"),
  ...
  _selectMenuItem({ key: e, target: t }) {
    ...
    n.length &&
      getproximoActiveElement(n, t, "ArrowDown" === e, !n.includes(t)).focus();
  }
  ...
  static clearMenus(e) {
    ...
    for (let n = 0, i = t.length; n < i; n++) {
      ...
      if (!i._element.classList.contains("Mostrar")) continue;
  ...
  static dataApiKeydownHandler(e) {
    if (
      ...
      return;
    const t = this.classList.contains("Mostrar");
...
class Backdrop {
  ...
  Mostrar(e) {
    this._config.isVisible
      ? (this._append(),
        ...
        this._getElement().classList.add("Mostrar"),
  ...
  hide(e) {
    this._config.isVisible
      ? (this._getElement().classList.remove("Mostrar"),
        this._emulateAnimation(() => {
...
const NAME$6 = "modal",
  ...
  EVENT_Mostrar$3 = "Mostrar.bs.modal",
  EVENT_MostrarN$3 = "Mostrarn.bs.modal",
...
class Modal extends BaseComponent {
  ...
  toggle(e) {
    return this._isMostrarn ? this.hide() : this.Mostrar(e);
  }
  Mostrar(e) {
    this._isMostrarn ||
      this._isTransitioning ||
      EventHandler.trigger(this._element, EVENT_Mostrar$3, { relatedTarget: e })
        .defaultPrevented ||
      ((this._isMostrarn = !0),
      ...
      this._MostrarBackdrop(() => this._MostrarElement(e)));
  }
  hide(e) {
    if (
      (e && ["A", "AREA"].includes(e.target.tagName) && e.preventDefault(),
      !this._isMostrarn || this._isTransitioning)
    )
      return;
  ...
  _MostrarElement(e) {
    ...
    (this._element.parentNode &&
      ...
      this._element.classList.add("Mostrar"),
...
EventHandler.on(
  ...
  function (e) {
    ...
    ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
      EventHandler.one(t, EVENT_Mostrar$3, (e) => {
        e.defaultPrevented ||
...
const NAME$5 = "offcanvas",
  ...
  CLASS_NAME_Mostrar$4 = "Mostrar",
  OPEN_SELECTOR = ".offcanvas.Mostrar",
  EVENT_Mostrar$2 = "Mostrar.bs.offcanvas",
  EVENT_MostrarN$2 = "Mostrarn.bs.offcanvas",
...
class Offcanvas extends BaseComponent {
  ...
  Mostrar(e) {
    this._isMostrarn ||
      EventHandler.trigger(this._element, EVENT_Mostrar$2, { relatedTarget: e })
        .defaultPrevented ||
      ((this._isMostrarn = !0),
...
EventHandler.on(
  ...
  EventHandler.on(window, EVENT_LOAD_DATA_API$1, () =>
    SelectorEngine.find(OPEN_SELECTOR).forEach((e) =>
      Offcanvas.getOrCreateInstance(e).Mostrar()
    )
  ),
...
const NAME$4 = "tooltip",
  ...
  Event$2 = {
    ...
    Mostrar: "Mostrar.bs.tooltip",
    MostrarN: "Mostrarn.bs.tooltip",
  ...
  CLASS_NAME_Mostrar$3 = "Mostrar",
  HOVER_STATE_Mostrar = "Mostrar",
  HOVER_STATE_OUT = "out",
...
class Tooltip extends BaseComponent {
  ...
  toggle(e) {
    if (this._isEnabled)
      if (e) {
        ...
        if (this.getTipElement().classList.contains("Mostrar"))
    ...
    this._queueCallback(
      () => {
        this._isWithActiveTrigger() ||
          ("Mostrar" !== this._hoverState && e.remove(),
          this._cleanTipClass(),
  ...
  setContent() {
    ...
    this.setElementContent(
      ...
      e.classList.remove("fade", "Mostrar");
  }
  ...
  _enter(e, t) {
    (t = this._initializeOnDelegatedTarget(e, t)),
      ...
      t.getTipElement().classList.contains("Mostrar") ||
      "Mostrar" === t._hoverState
        ? (t._hoverState = "Mostrar")
        : (clearTimeout(t._timeout),
          (t._hoverState = "Mostrar"),
          t._config.delay && t._config.delay.Mostrar
            ? (t._timeout = setTimeout(() => {
                "Mostrar" === t._hoverState && t.Mostrar();
              }, t._config.delay.Mostrar))
            : t.Mostrar());
  }
  _leave(e, t) {
    (t = this._initializeOnDelegatedTarget(e, t)),
  ...
  _getConfig(e) {
    ...
    return (
      ...
      "number" == typeof e.delay &&
        (e.delay = { Mostrar: e.delay, hide: e.delay }),
...
const NAME$3 = "popover",
  ...
  Event$1 = {
    ...
    Mostrar: "Mostrar.bs.popover",
    MostrarN: "Mostrarn.bs.popover",
...
const NAME$1 = "tab",
  ...
  EVENT_Mostrar$1 = "Mostrar.bs.tab",
  EVENT_MostrarN$1 = "Mostrarn.bs.tab",
...
class Tab extends BaseComponent {
  ...
  Mostrar() {
    ...
    const i = e
      ...
      : null;
    if (
      EventHandler.trigger(this._element, EVENT_Mostrar$1, { relatedTarget: e })
        .defaultPrevented ||
  ...
  _activate(e, t, n) {
    ...
    i && s
      ? (i.classList.remove("Mostrar"), this._queueCallback(o, e, !0))
      : o();
  }
  _transitionComplete(e, t, n) {
    ...
    e.classList.add("active"),
      ...
      reflow(e),
      e.classList.contains("fade") && e.classList.add("Mostrar");
    let i = e.parentNode;
    if (
...
EventHandler.on(
  ...
  function (e) {
    ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
      isDisabled(this) || Tab.getOrCreateInstance(this).Mostrar();
  }
),
...
const NAME = "toast",
  ...
  EVENT_Mostrar = "Mostrar.bs.toast",
  EVENT_MostrarN = "Mostrarn.bs.toast",
  CLASS_NAME_FADE = "fade",
  CLASS_NAME_HIDE = "hide",
  CLASS_NAME_Mostrar = "Mostrar",
  CLASS_NAME_MostrarING = "Mostraring",
...
class Toast extends BaseComponent {
  ...
  Mostrar() {
    EventHandler.trigger(this._element, EVENT_Mostrar).defaultPrevented ||
      (this._clearTimeout(),
      this._config.animation && this._element.classList.add("fade"),
      this._element.classList.remove("hide"),
      reflow(this._element),
      this._element.classList.add("Mostraring"),
      this._queueCallback(
        () => {
          this._element.classList.remove("Mostraring"),
            this._element.classList.add("Mostrar"),
