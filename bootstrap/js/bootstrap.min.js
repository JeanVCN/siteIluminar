...
!(function (t, e) {
  ...
  const i = {
      ...
      prev(t, e) {
        let s = t.AnteriorElementSibling;
        for (; s; ) {
          if (s.matches(e)) return [s];
          s = s.AnteriorElementSibling;
        }
        return [];
      },
      proximo(t, e) {
        let s = t.proximoElementSibling;
        for (; s; ) {
          if (s.matches(e)) return [s];
          s = s.proximoElementSibling;
        }
        return [];
      },
    },
  ...
  class et extends q {
    ...
    proximoWhenVisible() {
      !document.hidden && u(this._element) && this.proximo();
    }
    prev() {
      this._slide(G);
    }
    pause(t) {
      t || (this._isPaused = !0),
        i.findOne(
          ".carousel-item-proximo, .carousel-item-prev",
          this._element
    ...
    _slide(t, e) {
      const s = this._directionToOrder(t),
        ...
        d = c ? "carousel-item-proximo" : "carousel-item-prev",
  ...
  class nt extends q {
    ...
    Mostrar() {
      ...
      this._parent &&
        ((t = i
          .find(".Mostrar, .collapsing", this._parent)
          .filter((t) =>
      ...
      if (B.trigger(this._element, "Mostrar.bs.collapse").defaultPrevented)
        return;
      t &&
        t.forEach((t) => {
      ...
      this._queueCallback(
        () => {
          this._element.classList.remove("collapsing"),
            ...
            B.trigger(this._element, "Mostrarn.bs.collapse");
        },
        this._element,
        !0
      ),
    ...
    _addAriaAndCollapsedClass(t, e) {
      ...
      const s = t.classList.contains("Mostrar");
      e.forEach((t) => {
  ...
  class pt extends q {
    ...
    Mostrar() {
      if (g(this._element) || this._menu.classList.contains("Mostrar")) return;
      const t = pt.getParentFromElement(this._element),
        e = { relatedTarget: this._element };
      if (
        !B.trigger(this._element, "Mostrar.bs.dropdown", e).defaultPrevented
      ) {
        ...
        "ontouchstart" in document.documentElement &&
          ...
          B.trigger(this._element, "Mostrarn.bs.dropdown", e);
      }
    }
    hide() {
      if (g(this._element) || !this._menu.classList.contains("Mostrar")) return;
    ...
    _getMenuElement() {
      return i.proximo(this._element, ".dropdown-menu")[0];
    }
    _getPlacement() {
    ...
    static dataApiKeydownHandler(t) {
      if (
        ...
        return;
      const e = this.classList.contains("Mostrar");
  ...
  class wt extends q {
    ...
    toggle(t) {
      return this._isMostrarn ? this.hide() : this.Mostrar(t);
    }
    Mostrar(t) {
      this._isMostrarn ||
        this._isTransitioning ||
        B.trigger(this._element, "Mostrar.bs.modal", { relatedTarget: t })
          .defaultPrevented ||
        ((this._isMostrarn = !0),
        ...
        this._MostrarBackdrop(() => this._MostrarElement(t)));
    }
    hide(t) {
      if (
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._element.focus(),
              (this._isTransitioning = !1),
              B.trigger(this._element, "Mostrarn.bs.modal", {
                relatedTarget: t,
              });
          },
          this._dialog,
  ...
  class Tt extends q {
    ...
    Mostrar(t) {
      this._isMostrarn ||
        B.trigger(this._element, "Mostrar.bs.offcanvas", { relatedTarget: t })
          .defaultPrevented ||
        ((this._isMostrarn = !0),
        ...
        this._queueCallback(
          () => {
            B.trigger(this._element, "Mostrarn.bs.offcanvas", {
              relatedTarget: t,
            });
          },
          this._element,
  ...
  B.on(
    ...
    function (t) {
      ...
      const s = i.findOne(".offcanvas.Mostrar");
    ...
    B.on(window, "load.bs.offcanvas.data-api", () =>
      i
        .find(".offcanvas.Mostrar")
        .forEach((t) => Tt.getOrCreateInstance(t).Mostrar())
    ),
    y(Tt);
  const Ct = new Set([
      "background",
  ...
  class jt extends q {
    ...
    Mostrar() {
      ...
      const t = B.trigger(this._element, this.constructor.Event.Mostrar),
        e = p(this._element),
        i =
          null === e
      ...
      this._queueCallback(
        () => {
          ...
          (this._hoverState = null),
            B.trigger(this._element, this.constructor.Event.MostrarN),
      ...
      this._queueCallback(
        () => {
          this._isWithActiveTrigger() ||
            ("Mostrar" !== this._hoverState && t.remove(),
            this._cleanTipClass(),
    ...
    setContent() {
      ...
      this.setElementContent(i.findOne(".tooltip-inner", t), this.getTitle()),
        t.classList.remove("fade", "Mostrar");
    }
    ...
    _enter(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        ...
        e.getTipElement().classList.contains("Mostrar") ||
        "Mostrar" === e._hoverState
          ? (e._hoverState = "Mostrar")
          : (clearTimeout(e._timeout),
            (e._hoverState = "Mostrar"),
            e._config.delay && e._config.delay.Mostrar
              ? (e._timeout = setTimeout(() => {
                  "Mostrar" === e._hoverState && e.Mostrar();
                }, e._config.delay.Mostrar))
              : e.Mostrar());
    }
    _leave(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
    ...
    _getConfig(t) {
      ...
      return (
        ...
        "number" == typeof t.delay &&
          (t.delay = { Mostrar: t.delay, hide: t.delay }),
  ...
  class Ut extends q {
    ...
    Mostrar() {
      ...
      const n = t
        ...
        : null;
      if (
        B.trigger(this._element, "Mostrar.bs.tab", { relatedTarget: t })
          .defaultPrevented ||
      ...
      const o = () => {
        B.trigger(t, "hidden.bs.tab", { relatedTarget: this._element }),
          B.trigger(this._element, "Mostrarn.bs.tab", { relatedTarget: t });
      };
    ...
    _activate(t, e, s) {
      ...
      n && o
        ? (n.classList.remove("Mostrar"), this._queueCallback(r, t, !0))
        : r();
    }
    _transitionComplete(t, e, s) {
      ...
      t.classList.add("active"),
        ...
        m(t),
        t.classList.contains("fade") && t.classList.add("Mostrar");
      let n = t.parentNode;
      if (
  ...
  B.on(
    ...
    function (t) {
      ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        g(this) || Ut.getOrCreateInstance(this).Mostrar();
    }
  ),
    y(Ut);
  ...
  class Qt extends q {
    ...
    Mostrar() {
      B.trigger(this._element, "Mostrar.bs.toast").defaultPrevented ||
        (this._clearTimeout(),
        ...
        this._queueCallback(
          () => {
            this._element.classList.remove("Mostraring"),
              this._element.classList.add("Mostrar"),
              B.trigger(this._element, "Mostrarn.bs.toast"),
